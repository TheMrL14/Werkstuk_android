...
public class Recipe implements IDetailedRecipe<String>  {
    ...
    public List<IStep> getSteps() {
        ...
        for(Step s : analyzedInstructions.get(0).getSteps()) steps.add((IStep) s);
        return  steps;
    }
}
